...
import { fetchUsers, setSelectedUser } from "../../../stores/userSlice"; // 👉 make sure correct path
        ...
        <table className="w-full border border-gray-200 rounded-lg shadow-md dark:bg-gray-800 dark:border-gray-600">
          ...
          <tbody>
            {currentUsers.map((user) => (
              <tr
                key={user.id}
                className="hover:bg-gray-50 text-gray-800 dark:text-gray-300 dark:hover:bg-gray-700"
              >
